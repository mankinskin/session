...
- Commit the submodule first, then the superproject pointer — the deepest-first rule in [submodule.instructions.md](../../../../.agents/instructions/repository/submodule.instructions.md) is unchanged.
