...
Per [AGENTS.md](../../../../AGENTS.md#quality-gates)'s commit rule, worktree-backed commits land on the feature branch inside the worktree; a small main-checkout change may commit directly to `main` after validation when only its explicit path is staged. [workflow.instructions.md](../../../../.agents/instructions/repository/workflow.instructions.md) still governs staging batches, generated outputs, and message conventions, and [submodule.instructions.md](../../../../.agents/instructions/repository/submodule.instructions.md) still governs deepest-first submodule ordering. Two additions for worktree-backed commits:
